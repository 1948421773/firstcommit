...
public abstract class AutoLoopSwitchBaseView extends RelativeLayout implements ViewPager.OnPageChangeListener {
  ...
  private void initView() {
    ...
    params = generalLayoutParams(LayoutParams.MATCH_PARENT,(int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 30, displayMetrics));
//    params = generalLayoutParams(LayoutParams.MATCH_PARENT, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, displayMetrics));
  ...
  public boolean onInterceptTouchEvent(MotionEvent ev) {
    ...
    return super.onInterceptTouchEvent(ev);//1.true进行拦截 2.false Touch事件向下一级的View的dispatchTouchEvent()分发
//    return super.onInterceptTouchEvent(ev);//将会对该Touch事件进行拦截，会响应当前View的  OnTouchEvent()
  ...
  public boolean dispatchTouchEvent(MotionEvent ev) {
    ...
    return true;//false向上执行onTouchEvent
//    return super.dispatchTouchEvent(ev);//向下执行
  }*/
