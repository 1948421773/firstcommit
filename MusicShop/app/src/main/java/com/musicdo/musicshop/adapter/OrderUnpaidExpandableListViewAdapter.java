...
/**
 * 描述:
 * 作者：haiming on 2017/8/29 13:31
 * 邮箱：1948421773@qq.com
 * 版 本 ：1.0
 * 备 注 ：
 */

public class OrderUnpaidExpandableListViewAdapter extends BaseExpandableListAdapter implements View.OnClickListener {
     ...
     * @param context
     */
    public OrderUnpaidExpandableListViewAdapter(List<AllOrderBean> groups,Context context)
    {
        super();
        this.groups = groups;
//        this.children = children;
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)
    {
        ...
        final OrderUnpaidExpandableListViewAdapter.GroupHolder gholder;
        if (convertView == null)
        {
            gholder = new OrderUnpaidExpandableListViewAdapter.GroupHolder();
        ...
        {
            gholder = (OrderUnpaidExpandableListViewAdapter.GroupHolder) convertView.getTag();
        }
        ...
        if (group != null)
        {
            ...
            switch(group.getStatus()){//0等待付款，1已付款，2已发货，3已收货，4交易完成，5退款申请中，6退款完成，-1用户已取消，-2管理员已取消
                ...
                case 1:
                    ...
                    break;
                case 2:
                    gholder.tv_all_order_state.setText("卖家已发货");
                    break;
                case 3:
                    gholder.tv_all_order_state.setText("待评价");
                    break;
                case 4:
                ...
                case 6:
                    ...
                    break;
                case -1:
                    gholder.tv_all_order_state.setText("用户已取消");
                    break;
                case -2:
                    gholder.tv_all_order_state.setText("管理员已取消");
                    break;
            }
        }
        return convertView;
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent)
    {
        ...
        final OrderUnpaidExpandableListViewAdapter.ChildHolder cholder;
        if (convertView == null)
        {
            cholder = new OrderUnpaidExpandableListViewAdapter.ChildHolder();
            ...
            cholder.tv_payfor = (TextView) convertView.findViewById(R.id.tv_payfor);
            cholder.tv_cancel_order = (TextView) convertView.findViewById(R.id.tv_cancel_order);
            cholder.tv_payment = (TextView) convertView.findViewById(R.id.tv_payment);

            cholder.tv_remind_delivery = (TextView) convertView.findViewById(R.id.tv_remind_delivery);

            cholder.ll_unReceipt = (LinearLayout) convertView.findViewById(R.id.ll_unReceipt);
            cholder.tv_longtime_deliver = (TextView) convertView.findViewById(R.id.tv_longtime_deliver);
            cholder.tv_tracking_Logistics = (TextView) convertView.findViewById(R.id.tv_tracking_Logistics);
            ...
            cholder.tv_goto_evaluate = (TextView) convertView.findViewById(R.id.tv_goto_evaluate);

            convertView.setTag(cholder);
        } else
        {
            // convertView = childrenMap.get(groupPosition);
            cholder = (OrderUnpaidExpandableListViewAdapter.ChildHolder) convertView.getTag();
        }
