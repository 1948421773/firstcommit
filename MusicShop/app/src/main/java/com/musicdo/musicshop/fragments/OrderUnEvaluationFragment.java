...
import com.musicdo.musicshop.adapter.UnEvaluationOrderExpandableListViewAdapter;
...
/**
 * 描述:待评价
 * 作者：haiming on 2017/8/28 15:08
 * 邮箱：1948421773@qq.com
 * 版 本 ：1.0
 * 备 注 ：
 */

public class OrderUnEvaluationFragment extends BaseFragment implements View.OnClickListener,
        UnEvaluationOrderExpandableListViewAdapter.GotoEvaluate,
        UnEvaluationOrderExpandableListViewAdapter.TackingLogistics,
        UnEvaluationOrderExpandableListViewAdapter.AdditionalComments,
        UnEvaluationOrderExpandableListViewAdapter.DeleteOrder,
        RefreshCompleteCallBack {
    View rootView;
    private final static String TAG = "OrderUnEvaluationFragment";
...
//    private MySwipeRefreshLayout swipeRefreshLayout;
    ...
    private UnEvaluationOrderExpandableListViewAdapter selva;
...
//        if(selva==null){
            selva = new UnEvaluationOrderExpandableListViewAdapter(allOrderBeans, mContext);
...
//        ToastUtil.showShort(mContext,"追加评价");
        List<String> imgs=new ArrayList<>();
        List<String> prodTitles=new ArrayList<>();
        List<Integer> prodIds=new ArrayList<>();
        int shopId=0;
