...
//        ToastUtil.showShort(activity,"初始化GoodsDetailFragment");
        if (rootView==null) {
            rootView = inflater.inflate(R.layout.fragment_goods_detail, null);
            pridId=getArguments().getInt("ID",0);
            initView();
            initListener();
        }
        return rootView;
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt("pridId",pridId);
//        activity.getSupportFragmentManager().putFragment(outState, "GoodsDetailWebFragment", goodsDetailWebFragment);
    }
    ...
    public void onViewStateRestored(@Nullable Bundle savedInstanceState) {
        ...
        pridId=savedInstanceState.getInt("pridId",0);
        }
    }
