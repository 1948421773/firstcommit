...
public class ShopCatetoryAndBrandAdapter extends RecyclerView.Adapter<ShopCatetoryAndBrandAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public ShopCatetoryAndBrandAdapter(Context content, ArrayList<CategoryLevelOneBean> categoryLevelOneBeans) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_shopcategroyandbrand, viewGroup, false);
