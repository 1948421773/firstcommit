...
/**
 * 描述:
 * 作者：haiming on 2017/8/3 15:41
 * 邮箱：1948421773@qq.com
 * 版 本 ：1.0
 * 备 注 ：
 */

public class SpecMateriaGridAdapter extends RecyclerView.Adapter<SpecMateriaGridAdapter.MyViewHolder> implements View.OnClickListener {
...
//适配器初始化
    ...
    public SpecMateriaGridAdapter(Context context,ArrayList<SpecitemDataBean> datas){
        mContext=context;
        this.datas=datas;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SpecMateriaGridAdapter.MyViewHolder(view);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.cb_spec_color_chekbox:
                ...
                checkInterface.checkChild(2,(int) v.getTag());// 暴露组选接口,材质组下标为2
                break;
        }
    }
