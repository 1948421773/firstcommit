...
public class ProductLookItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener,View.OnLongClickListener{
    private Context mContext;
    View rootView;
    OnSearchItemClickListener mOnItemClickListener;
    OnSearchItemLongClickListener mOnItemLongClickListener;
    private List<DataListBean> itemGridList;
    ...
    public ProductLookItemAdapter(Context context, List<DataListBean> itemGridList, boolean showtype){
        mContext=context;
...
//        if (viewType == TYPE_ITEM_LIST) {
        ...
        ProductLookItemAdapter.MyViewHolder holder = new ProductLookItemAdapter.MyViewHolder(view);
        view.setOnClickListener(this);
        view.setOnLongClickListener(this);
        return holder;
//        }
        /*else{
            ProductLookItemAdapter.MyViewHolderFooterView holderFooterView = new ProductLookItemAdapter.MyViewHolderFooterView(LayoutInflater.from(
...
//        if(holder instanceof MyViewHolder) {
        ...
        ((MyViewHolder)holder).iv_popularity_icon.setImageURI(AppConstants.PhOTOADDRESS + itemGridList.get(position).getImgUrl());
        ((MyViewHolder)holder).tv_searchprod_item_title.setText(itemGridList.get(position).getName());
        ((MyViewHolder)holder).tv_popularity_price.setText(mContext.getResources().getString(R.string.pricesymbol)+String.valueOf(itemGridList.get(position).getPrice()));
