...
public class UnpaidOrderExpandableListViewAdapter extends BaseExpandableListAdapter implements View.OnClickListener {
     ...
     * @param context
     */
    public UnpaidOrderExpandableListViewAdapter(List<AllOrderBean> groups,Context context)
    {
        super();
        this.groups = groups;
//        this.children = children;
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)
    {
        ...
        final UnpaidOrderExpandableListViewAdapter.GroupHolder gholder;
        if (convertView == null)
        {
            gholder = new UnpaidOrderExpandableListViewAdapter.GroupHolder();
        ...
        {
            gholder = (UnpaidOrderExpandableListViewAdapter.GroupHolder) convertView.getTag();
        }
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent)
    {
        ...
        final UnpaidOrderExpandableListViewAdapter.ChildHolder cholder;
        if (convertView == null)
        {
            cholder = new UnpaidOrderExpandableListViewAdapter.ChildHolder();
        ...
        } else
        {
            ...
            cholder = (UnpaidOrderExpandableListViewAdapter.ChildHolder) convertView.getTag();
        }
...
//            }
            ...
            cholder.tv_tracking_Logistics.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    String orderNumber=product.getOrderNumber();
                    int orderShopID=product.getShopID();
                    tackingLogistics.doTackingLogistics(orderNumber, orderShopID,null);// 暴露组选接口
