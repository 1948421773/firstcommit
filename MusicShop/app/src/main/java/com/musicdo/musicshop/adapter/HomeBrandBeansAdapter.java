...
public class HomeBrandBeansAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    private Context mContext;
    View rootView;
    OnSearchItemClickListener mOnItemClickListener;
    private ArrayList<HomeBrandBean> datas;//数据
    ...
    public HomeBrandBeansAdapter(Context context,ArrayList<HomeBrandBean> datas,boolean showtype){
        mContext=context;
        this.datas=datas;
