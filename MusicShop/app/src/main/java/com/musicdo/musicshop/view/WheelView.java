...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
       ...
       /* textColorOut = getResources().getColor(R.color.pickerview_wheelview_textcolor_out);
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SlideDetailsLayout, 0, 0);
            mGravity = a.getInt(R.styleable.SlideDetailsLayout_pickerview_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.SlideDetailsLayout_pickerview_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.SlideDetailsLayout_pickerview_textColorCenter, textColorCenter);
            dividerColor = a.getColor(R.styleable.SlideDetailsLayout_pickerview_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.SlideDetailsLayout_pickerview_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.SlideDetailsLayout_pickerview_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
