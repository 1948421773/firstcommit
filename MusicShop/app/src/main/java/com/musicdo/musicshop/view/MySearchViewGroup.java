...
/**
 * 描述:搜索历史记录布局
 * 作者：haiming on 2017/7/25 15:52
 * 邮箱：1948421773@qq.com
 * 版 本 ：1.0
 * 备 注 ：
 */

public class MySearchViewGroup extends ViewGroup {
    private static final String TAG = "zxt/FlowViewGroup";

    public MySearchViewGroup(Context context) {
        this(context, null);
    }

    public MySearchViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MySearchViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
