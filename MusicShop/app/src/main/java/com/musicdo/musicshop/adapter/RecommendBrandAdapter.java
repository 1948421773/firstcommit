...
public class RecommendBrandAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    private Context mContext;
    View rootView;
    OnSearchItemClickListener mOnItemClickListener;
    private ArrayList<RecommendBrandBean> datas;//数据
    ...
    public RecommendBrandAdapter(Context context,ArrayList<RecommendBrandBean> datas,boolean showtype){
        mContext=context;
        this.datas=datas;
