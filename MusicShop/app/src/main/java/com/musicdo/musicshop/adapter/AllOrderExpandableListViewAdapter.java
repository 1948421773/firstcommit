...
/**
 * 描述:
 * 作者：haiming on 2017/8/25 15:53
 * 邮箱：1948421773@qq.com
 * 版 本 ：1.0
 * 备 注 ：
 */

public class AllOrderExpandableListViewAdapter extends BaseExpandableListAdapter implements View.OnClickListener {
...
//    private List<CartItemBean> children=new ArrayList<>();
     ...
     * @param context
     */
    public AllOrderExpandableListViewAdapter(List<AllOrderBean> groups,Context context)
    {
        super();
        this.groups = groups;
//        this.children = children;
    ...
    public int getChildrenCount(int groupPosition)
    {
        ...
        if (groups!=null){
            ...
            if (groups.get(groupPosition)!=null){
                if (groups.get(groupPosition).getOrderDetail()!=null){
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)
    {
        ...
        final AllOrderExpandableListViewAdapter.GroupHolder gholder;
        if (convertView == null)
        {
            gholder = new AllOrderExpandableListViewAdapter.GroupHolder();
        ...
        {
            gholder = (AllOrderExpandableListViewAdapter.GroupHolder) convertView.getTag();
        }
        if (groups!=null){
           if (groups.size()!=0){
               if (groups.get(groupPosition)!=null){
                   ...
                   if (group != null)
                   {
                       ...
                       switch(group.getStatus()){//0等待付款，1已付款，2已发货，3已收货，4交易完成，5退款申请中，6退款完成，-1用户已取消，-2管理员已取消
                           ...
                           case 1:
                               ...
                               break;
                           case 2:
                               gholder.tv_all_order_state.setText("已发货");
                               break;
                           case 3:
                               gholder.tv_all_order_state.setText("交易完成");
                               break;
                           case 4:
                               gholder.tv_all_order_state.setText("退款处理中");
                               break;
                           case 5:
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent)
    {
        ...
        final AllOrderExpandableListViewAdapter.ChildHolder cholder;
        if (convertView == null)
        {
            cholder = new AllOrderExpandableListViewAdapter.ChildHolder();
            ...
            cholder.tv_applyfor_refund.setVisibility(View.GONE);
        ...
        } else
        {
            ...
            cholder = (AllOrderExpandableListViewAdapter.ChildHolder) convertView.getTag();
        }
//		final CartItemBean product =groups.get(groupPosition).getProductDetail().get(childPosition);
        ...
        /*if(groups.get(groupPosition).getStatus()==4){//退款订单特殊处理，每个item单独退款退货
...
//            }
            ...
            cholder.tv_tracking_Logistics.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    int orderShopID=product.getShopID();
                    tackingLogistics.doTackingLogistics(orderNumber, orderShopID,url,groupPosition);// 暴露组选接口
            ...
            cholder.tv_tracking_Logistics_tow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String url=product.getSrc();
                    int orderShopID=product.getShopID();
                    tackingLogistics_tow.doTackingLogistics_tow(orderNumber, orderShopID,orderName,url,groupPosition);// 暴露组选接口
            ...
            cholder.tv_applyfor_refund.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("LogisticsName",groups.get(groupPosition).getLogisticsName());
                    intent.putExtra("LogisticsCode",groups.get(groupPosition).getLogisticsCode());
                    context.startActivity(intent);
                    /*String orderNumber = product.getOrderNumber();
                    ...
                    applyforRefund.doApplyforRefund(orderNumber, ProductId, username,icon,title,param,SpUtils.doubleToString(price));// 暴露组选接口*/
            ...
            cholder.rl_purchaselist_item_title.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {//订单详情
                    ...
                    intent.putExtra("Number",product.getOrderNumber());//订单编号
                    intent.putExtra("orderState",product.getStatusID());//订单编号
                    String ln=groups.get(groupPosition).getLogisticsName();
                    String lc=groups.get(groupPosition).getLogisticsCode();
                    intent.putExtra("LogisticsName",ln);
                    intent.putExtra("LogisticsCode",lc);
                    context.startActivity(intent);
                }
            });
        }
    ...
    public interface TackingLogistics
    {
         ...
         * @param UserName	用户名
         */
        public void doTackingLogistics(String OrderNumber, int ShopID,String UserName,int position);
    }
    public interface TackingLogistics_tow
    {
         ...
         * @param UserName	用户名
         */
        public void doTackingLogistics_tow(String OrderNumber, int ShopID,String UserName,String url,int position);
    }
