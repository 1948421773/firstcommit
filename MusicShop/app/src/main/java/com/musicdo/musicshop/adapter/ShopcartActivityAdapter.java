...
import com.musicdo.musicshop.activity.ShopCartActivitySpecActivity;
...
public class ShopcartActivityAdapter extends BaseExpandableListAdapter implements View.OnClickListener {
     ...
     * @param context
     */
    public ShopcartActivityAdapter(List<CartBean> groups, List<CartItemBean> children, Context context, ArrayList<SpecItemBean> specItemBeens)
    {
        super();
        this.groups = groups;
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)
    {
        ...
        if (groups.size()!=0&&groups.get(groupPosition).getProductDetail().size()!=0) {
            ...
            if (group != null) {
                ...
                gholder.tv_cart_item_edit.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
...
//		final CartItemBean product =groups.get(groupPosition).getProductDetail().get(childPosition);
        ...
        if (product != null){
            ...
            cholder.ll_choose_parameter.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
...
//							specItemBeans.addAll(specBeans.getData());
                            Intent intent = new Intent(context, ShopCartActivitySpecActivity.class);
            ...
            cholder.ll_cart_item_delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
