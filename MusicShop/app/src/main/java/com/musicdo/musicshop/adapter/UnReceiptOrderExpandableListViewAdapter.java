...
public class UnReceiptOrderExpandableListViewAdapter extends BaseExpandableListAdapter implements View.OnClickListener {
     ...
     * @param context
     */
    public UnReceiptOrderExpandableListViewAdapter(List<AllOrderBean> groups, Context context) {
        super();
        this.groups = groups;
//        this.children = children;
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        final UnReceiptOrderExpandableListViewAdapter.GroupHolder gholder;
        if (convertView == null) {
            gholder = new UnReceiptOrderExpandableListViewAdapter.GroupHolder();
            ...
            gholder = (UnReceiptOrderExpandableListViewAdapter.GroupHolder) convertView.getTag();
        }
        if (groups != null) {
            if (groups.size() != 0) {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        final UnReceiptOrderExpandableListViewAdapter.ChildHolder cholder;
        if (convertView == null) {
            cholder = new UnReceiptOrderExpandableListViewAdapter.ChildHolder();
            ...
            cholder.tv_confirm_receipt = (TextView) convertView.findViewById(R.id.tv_confirm_receipt);//确认收货
            cholder.tv_applyfor_refund = (TextView) convertView.findViewById(R.id.tv_applyfor_refund);//申请退款
            ...
            cholder.tv_tracking_Logistics_tow = (TextView) convertView.findViewById(R.id.tv_tracking_Logistics_tow);//我要评价
            ...
            cholder = (UnReceiptOrderExpandableListViewAdapter.ChildHolder) convertView.getTag();
        }
//		final CartItemBean product =groups.get(groupPosition).getProductDetail().get(childPosition);
        ...
        /*if(product.getStatusID()==2){//状态未2待收货 退款订单特殊处理，每个item单独退款退货
...
//            }
            ...
            cholder.tv_applyfor_refund.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("Name",product.getName());//订单编号
                    intent.putExtra("orderState",product.getStatusID());//订单编号
                    intent.putExtra("OrdProID",product.getID());//商品订单的ID
                    context.startActivity(intent);
                    /*String orderNumber = product.getOrderNumber();
