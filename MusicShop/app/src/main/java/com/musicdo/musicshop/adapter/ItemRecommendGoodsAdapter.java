...
public class ItemRecommendGoodsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_goods_price.setText(context.getResources().getString(R.string.pricesymbol)+ recommendGoods.getCurrentPrice());
        holder.sdv_goods.setImageURI(Uri.parse(recommendGoods.getImag()));
        holder.tv_goods_old_price.setText(context.getResources().getString(R.string.pricesymbol)+ recommendGoods.getPrice());
        return convertView;
    }
