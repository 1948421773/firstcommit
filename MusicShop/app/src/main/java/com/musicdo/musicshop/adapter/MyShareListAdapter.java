...
private List<SharelistBean> itemGridList;
...
public MyShareListAdapter(Context context, List<SharelistBean> itemGridList, boolean showtype){
        mContext=context;
...
//        if (viewType == TYPE_ITEM_LIST) {
        ...
        MyShareListAdapter.MyViewHolder holder = new MyShareListAdapter.MyViewHolder(view);
...
//        if(holder instanceof MyViewHolder) {
        ((MyViewHolder)holder).tv_similar.setVisibility(View.GONE);
        ...
        ((MyViewHolder)holder).tv_searchprod_item_title.setText(itemGridList.get(position).getProname());
        ((MyViewHolder)holder).tv_popularity_price.setTextColor(mContext.getResources().getColor(R.color.btg_global_black_content));
        ((MyViewHolder)holder).tv_popularity_price.setText(itemGridList.get(position).getDate());
