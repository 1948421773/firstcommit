...
//    private SimpleViewSwitcher mProgressBar;
    ...
    private void initView() {
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.orderlistview_header, null);
    ...
    public void setProgressStyle(int style) {
        if (style == ProgressStyle.SysProgress) {
            ...
            progressBar.setIndeterminateDrawable(getResources().getDrawable(R.drawable.progressbar_circle_1));
