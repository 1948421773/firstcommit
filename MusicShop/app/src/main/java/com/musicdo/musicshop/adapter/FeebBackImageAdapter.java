...
public class FeebBackImageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public FeebBackImageAdapter(Context context, List<String> datas){
        mContext=context;
        this.datas=datas;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ((MyViewHolder)holder).im_evaluate_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                deleteEvaluateImags.DeleteImgs(path,name,position);
            }
        });
